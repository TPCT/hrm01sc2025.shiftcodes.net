...
//            }
    ...
    public function newCheckIn($validatedData)
    {
        ...
        $validatedData['check_in_latitude'] = $validatedData['latitude'] ?? $validatedData['check_in_latitude'] ?? $coordinate['latitude'];
        $validatedData['check_in_longitude'] = $validatedData['longitude'] ?? $validatedData['check_in_longitude'] ?? $coordinate['longitude'];
    ...
    public function newCheckOut($attendanceData, $validatedData)
    {
        ...
        $validatedData['check_out_latitude'] = $validatedData['latitude'] ?? $validatedData['check_out_latitude'] ?? $coordinate['latitude'];
        $validatedData['check_out_longitude'] = $validatedData['longitude'] ?? $validatedData['check_out_longitude'] ?? $coordinate['longitude'];
