                ...
                <div class="col-lg-12">
                    <div class="group-checkbox border-bottom pb-3 mb-4 w-100">
                        <div class="title-ch mb-2">
                            <h5 style="color:#e82e5f;">{{__("permissions." . \Illuminate\Support\Str::slug($value->name))}}:</h5>
                        </div>
                                    ...
                                    <li class="item">
                                        <label class="label lh-1">
                                            <input class="module_checkbox"
                                                   ...
                                                   value="{{$permission->id}}"
                                                {{$checked}}>
                                            <span class="text">{{__('permissions.' . \Illuminate\Support\Str::slug($permission->name))}}
                                    </span>
